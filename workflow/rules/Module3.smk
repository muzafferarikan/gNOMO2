...
rule augustus:
	input:
		sample = "results/intermediate_files/spades/{omics}_{sample}/contigs.fasta"
	output:
		output = "results/intermediate_files/augustus/{omics}_{sample}/augustus_output.gff"
	conda:
...
rule merge_all_samples:
	...
	output:
		output = "results/intermediate_files/prot_db/database_MP.fasta"
	shell:
		"cat {input} > {output}"
...
rule seqkit_rmdup:
	input:
		"results/intermediate_files/prot_db/database_MP.fasta"
	output:
...
rule tigrfam_diff:
	...
	output:
		"results/final/diff_abun/tigrfam-maaslin2-MG/maaslin2.log"
	params:
